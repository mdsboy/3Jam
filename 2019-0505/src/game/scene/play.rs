...
impl Play {
    pub fn new(location: web_sys::Location, window: Rect, stage: usize) -> Play {
        ...
        Play {/*
            ...
            score2: 0,
            window: window,
            rect1: Rect::new(Point::new(100.0, 350.0), 180.0, 100.0, "red"),
            rect2: Rect::new(Point::new(900.0, 350.0), 180.0, 100.0, "blue"),
            next: false,
            cnt: 0,
            win: false,
        }
    ...
    pub fn tweet(&self) {
        ...
        let url = "https://mdsboy.github.io/3Jam/2019-0505/dist";
